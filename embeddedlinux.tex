...
{\emph{Professor}, ETSI Sistemas de Telecomunicación \\
...
\input{trainingmaterials/slides/sysdev-toolchains-title/sysdev-toolchains-title}
...
\input{trainingmaterials/slides/sysdev-bootloaders-title/sysdev-bootloaders-title}
\input{trainingmaterials/slides/sysdev-bootloaders-sequence/sysdev-bootloaders-sequence}
\input{trainingmaterials/slides/sysdev-linux-intro-title/sysdev-linux-intro-title}
...
\input{trainingmaterials/slides/sysdev-root-filesystem-title/sysdev-root-filesystem-title}
